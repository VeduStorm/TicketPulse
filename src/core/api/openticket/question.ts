 ...
 * This is an TicketPulse question manager.
 * 
...
export interface ODQuestionJson {
    ...
    type:string,
    /**The version of TicketPulse used to create this question. */
    version:string,
...
/**## ODQuestion `class`
 * This is an TicketPulse question.
 * 
 ...
 * This is TicketPulse question data.
 * 
 ...
 * This is an TicketPulse short question.
 * 
 * This class contains all data related to an TicketPulse short question (parsed from the config).
 * 
 ...
 * This is an TicketPulse paragraph question.
 * 
 * This class contains all data related to an TicketPulse paragraph question (parsed from the config).
 * 
