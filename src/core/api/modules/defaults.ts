...
export interface ODDefaults {
    ...
    /**Enable loading all TicketPulse plugins, sadly enough is only useful for the system :) */
    pluginLoading:boolean,
    /**Don't crash the bot when a plugin crashes! */
    softPluginLoading:boolean,

    /**Load the default TicketPulse plugin classes. */
    pluginClassLoading:boolean,

    /**Load the default TicketPulse flags. */
    flagLoading:boolean,
    /**Enable the default initializer for TicketPulse flags. */
    flagInitiating:boolean,
    /**Load the default TicketPulse progress bar renderers. */
    progressBarRendererLoading:boolean,
    /**Load the default TicketPulse progress bars. */
    progressBarLoading:boolean,
    /**Load the default TicketPulse configs. */
    configLoading:boolean,
    /**Enable the default initializer for TicketPulse config. */
    configInitiating:boolean,
    /**Load the default TicketPulse databases. */
    databaseLoading:boolean,
    /**Enable the default initializer for TicketPulse database. */
    databaseInitiating:boolean,
    /**Load the default TicketPulse sessions. */
    sessionLoading:boolean,

    /**Load the default TicketPulse languages. */
    languageLoading:boolean,
    /**Enable the default initializer for TicketPulse languages. */
    ...
    /**Load the default TicketPulse config checker. */
    checkerLoading:boolean,
    /**Load the default TicketPulse config checker functions. */
    checkerFunctionLoading:boolean,
    /**Enable the default execution of the config checkers. */
    checkerExecution:boolean,
    /**Load the default TicketPulse config checker translations. */
    ...
    /**Load the default TicketPulse client configuration. */
    clientLoading:boolean,
    /**Load the default TicketPulse client initialization. */
    clientInitiating:boolean,
    /**Load the default TicketPulse client ready actions (status, commands, permissions, ...). */
    clientReady:boolean,
    /**Create a warning when the bot is present in multiple guilds. */
    clientMultiGuildWarning:boolean,
    /**Load the default TicketPulse client activity (from `config/general.json`). */
    clientActivityLoading:boolean,
    /**Load the default TicketPulse client activity initialization (& status refresh). */
    clientActivityInitiating:boolean,

    /**Load the default TicketPulse slash commands. */
    slashCommandLoading:boolean,
    /**Load the default TicketPulse slash command registerer (register slash cmds in discord). */
    ...
    /**When enabled, the bot is allowed to unregister all slash commands which aren't used in TicketPulse. Disable this if you don't want to use the TicketPulse `ODSlashCommand` classes. */
    allowSlashCommandRemoval:boolean,
    /**Load the default TicketPulse text commands. */
    textCommandLoading:boolean,

    /**Load the default TicketPulse questions (from `config/questions.json`) */
    questionLoading:boolean,
    /**Load the default TicketPulse options (from `config/options.json`) */
    optionLoading:boolean,
    /**Load the default TicketPulse panels (from `config/panels.json`) */
    panelLoading:boolean,
    /**Load the default TicketPulse tickets (from `database/tickets.json`) */
    ticketLoading:boolean,
    /**Load the default TicketPulse reaction roles (from `config/options.json`) */
    roleLoading:boolean,
    /**Load the default TicketPulse blacklist (from `database/users.json`) */
    blacklistLoading:boolean,
    /**Load the default TicketPulse transcript compilers. */
    transcriptCompilerLoading:boolean,
    /**Load the default TicketPulse transcript history (from `database/transcripts.json`) */
    transcriptHistoryLoading:boolean,

    /**Load the default TicketPulse button builders. */
    buttonBuildersLoading:boolean,
    /**Load the default TicketPulse dropdown builders. */
    dropdownBuildersLoading:boolean,
    /**Load the default TicketPulse file builders. */
    fileBuildersLoading:boolean,
    /**Load the default TicketPulse embed builders. */
    embedBuildersLoading:boolean,
    /**Load the default TicketPulse message builders. */
    messageBuildersLoading:boolean,
    /**Load the default TicketPulse modal builders. */
    modalBuildersLoading:boolean,

    /**Load the default TicketPulse command responders. */
    commandRespondersLoading:boolean,
    /**Load the default TicketPulse button responders. */
    buttonRespondersLoading:boolean,
    /**Load the default TicketPulse dropdown responders. */
    dropdownRespondersLoading:boolean,
    /**Load the default TicketPulse modal responders. */
    modalRespondersLoading:boolean,
    /**Set the time (in ms) before TicketPulse sends an error message when no reply is sent in a responder. */
    responderTimeoutMs:number,

    /**Load the default TicketPulse actions. */
    actionsLoading:boolean,

    /**Load the default TicketPulse verify bars. */
    verifyBarsLoading:boolean,
    /**Load the default TicketPulse permissions. */
    permissionsLoading:boolean,
    /**Load the default TicketPulse posts. */
    postsLoading:boolean,
    /**Initiate the default TicketPulse posts. */
    postsInitiating:boolean,
    /**Load the default TicketPulse cooldowns. */
    cooldownsLoading:boolean,
    /**Initiate the default TicketPulse cooldowns. */
    cooldownsInitiating:boolean,
    /**Load the default TicketPulse help menu categories. */
    helpMenuCategoryLoading:boolean,
    /**Load the default TicketPulse help menu components. */
    helpMenuComponentLoading:boolean,

    /**Load the default TicketPulse stat scopes. */
    statScopesLoading:boolean,
    /**Load the default TicketPulse stats. */
    statLoading:boolean,
    /**Initiate the default TicketPulse stats. */
    statInitiating:boolean,

    /**Load the default TicketPulse code/functions. */
    codeLoading:boolean,
    /**Execute the default TicketPulse code/functions. */
    codeExecution:boolean,

    /**Load the default TicketPulse livestatus. */
    liveStatusLoading:boolean,
    /**Load the default TicketPulse startscreen. */
    startScreenLoading:boolean,
    /**Render the default TicketPulse startscreen. */
    startScreenRendering:boolean,

    /**Load the emoji style from the TicketPulse general config. */
 ...
 * This is an TicketPulse defaults manager.
 * 
 * It manages all settings in TicketPulse that are not meant to be in the config.
 * Here you can disable certain default features to replace them or to specifically enable them!
 * 
 * You are unable to add your own defaults, you can only edit TicketPulse defaults!
 */
