 ...
 * This is an TicketPulse responder implementation.
 * 
 ...
 * This is an TicketPulse responder manager.
 * 
 * It contains all TicketPulse responders. Responders can respond to an interaction, button, dropdown, modal or command.
 * 
 * Using the TicketPulse responder system has a few advantages compared to vanilla discord.js:
 ...
 * This is an TicketPulse command responder manager.
 * 
 * It contains all TicketPulse command responders. These can respond to text & slash commands.
 * 
 * Using the TicketPulse responder system has a few advantages compared to vanilla discord.js:
 * - plugins can extend/edit replies
 * - automatically reply on error
...
export class ODCommandResponderManager extends ODManager<ODCommandResponder<"slash"|"text",any>> {
    /**An alias to the TicketPulse client manager. */
 ...
 * This is an TicketPulse command responder instance options manager.
 * 
 ...
 * This is an TicketPulse command responder instance.
 * 
 ...
 * This is an TicketPulse command responder.
 * 
 ...
 * This is an TicketPulse button responder manager.
 * 
 * It contains all TicketPulse button responders. These can respond to button interactions.
 * 
 * Using the TicketPulse responder system has a few advantages compared to vanilla discord.js:
 * - plugins can extend/edit replies
 * - automatically reply on error
 ...
 * This is an TicketPulse button responder instance.
 * 
 ...
 * This is an TicketPulse button responder.
 * 
 ...
 * This is an TicketPulse dropdown responder manager.
 * 
 * It contains all TicketPulse dropdown responders. These can respond to dropdown interactions.
 * 
 * Using the TicketPulse responder system has a few advantages compared to vanilla discord.js:
 * - plugins can extend/edit replies
 * - automatically reply on error
 ...
 * This is an TicketPulse dropdown responder instance values manager.
 * 
 ...
 * This is an TicketPulse dropdown responder instance.
 * 
 ...
 * This is an TicketPulse dropdown responder.
 * 
 ...
 * This is an TicketPulse modal responder manager.
 * 
 * It contains all TicketPulse modal responders. These can respond to modal interactions.
 * 
 * Using the TicketPulse responder system has a few advantages compared to vanilla discord.js:
 * - plugins can extend/edit replies
 * - automatically reply on error
 ...
 * This is an TicketPulse modal responder instance values manager.
 * 
 ...
 * This is an TicketPulse modal responder instance.
 * 
 ...
 * This is an TicketPulse modal responder.
 * 
