...
export interface ODLanguageMetadata {
    /**The version of TicketPulse this translation is made for. */
    otversion:string,
 ...
 * This is an TicketPulse language manager.
 * 
...
export class ODLanguageManager extends ODManager<ODLanguage> {
    ...
    /**An alias to TicketPulse debugger. */
    #debug: ODDebugger
...
/**## ODLanguage `class`
 * This is an TicketPulse language file.
 * 
 ...
 * This is an TicketPulse JSON language file.
 * 
