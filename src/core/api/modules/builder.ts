 ...
 * This is an TicketPulse builder implementation.
 * 
 ...
 * This is an TicketPulse builder manager.
 * 
 * It contains all TicketPulse builders. You can find messages, embeds, files & dropdowns, buttons & modals all here!
 * 
 * Using the TicketPulse builder system has a few advantages compared to vanilla discord.js:
 ...
 * This is an TicketPulse button manager.
 * 
 * It contains all TicketPulse button builders. Here, you can add your own buttons or edit existing ones!
 * 
 * It's recommended to use this system in combination with all the other TicketPulse builders!
 */
 ...
 * This is an TicketPulse button instance.
 * 
...
/**## ODButton `class`
 * This is an TicketPulse button builder.
 * 
 * With this class, you can create a button to use in a message.
 * The only difference with normal buttons is that this one can be edited by TicketPulse plugins!
 * 
...
/**## ODQuickButton `class`
 * This is an TicketPulse quick button builder.
 * 
 * With this class, you can quickly create a button to use in a message.
 * This quick button can be used by TicketPulse plugins instead of the normal builders to speed up the process!
 * 
 ...
 * This is an TicketPulse dropdown manager.
 * 
 * It contains all TicketPulse dropdown builders. Here, you can add your own dropdowns or edit existing ones!
 * 
 * It's recommended to use this system in combination with all the other TicketPulse builders!
 */
 ...
 * This is an TicketPulse dropdown instance.
 * 
...
/**## ODDropdown `class`
 * This is an TicketPulse dropdown builder.
 * 
 * With this class, you can create a dropdown to use in a message.
 * The only difference with normal dropdowns is that this one can be edited by TicketPulse plugins!
 * 
 * This is possible by using "workers" or multiple functions that will be executed in priority order!
 */
 ...
 * This is an TicketPulse quick dropdown builder.
 * 
 * With this class, you can quickly create a dropdown to use in a message.
 * This quick dropdown can be used by TicketPulse plugins instead of the normal builders to speed up the process!
 * 
...
/**## ODFileManager `class`
 * This is an TicketPulse file manager.
 * 
 * It contains all TicketPulse file builders. Here, you can add your own files or edit existing ones!
 * 
 * It's recommended to use this system in combination with all the other TicketPulse builders!
 */
 ...
 * This is an TicketPulse file instance.
 * 
...
/**## ODFile `class`
 * This is an TicketPulse file builder.
 * 
 * With this class, you can create a file to use in a message.
 * The only difference with normal files is that this one can be edited by TicketPulse plugins!
 * 
 * This is possible by using "workers" or multiple functions that will be executed in priority order!
 */
...
/**## ODQuickFile `class`
 * This is an TicketPulse quick file builder.
 * 
 * With this class, you can quickly create a file to use in a message.
 * This quick file can be used by TicketPulse plugins instead of the normal builders to speed up the process!
 * 
 ...
 * This is an TicketPulse embed manager.
 * 
 * It contains all TicketPulse embed builders. Here, you can add your own embeds or edit existing ones!
 * 
 * It's recommended to use this system in combination with all the other TicketPulse builders!
 */
 ...
 * This is an TicketPulse embed instance.
 * 
...
/**## ODEmbed `class`
 * This is an TicketPulse embed builder.
 * 
 * With this class, you can create a embed to use in a message.
 * The only difference with normal embeds is that this one can be edited by TicketPulse plugins!
 * 
 * This is possible by using "workers" or multiple functions that will be executed in priority order!
 */
...
/**## ODQuickEmbed `class`
 * This is an TicketPulse quick embed builder.
 * 
 * With this class, you can quickly create a embed to use in a message.
 * This quick embed can be used by TicketPulse plugins instead of the normal builders to speed up the process!
 * 
 ...
 * This is an TicketPulse message manager.
 * 
 * It contains all TicketPulse message builders. Here, you can add your own messages or edit existing ones!
 * 
 * It's recommended to use this system in combination with all the other TicketPulse builders!
 */
...
export interface ODMessageData {
    ...
    /**Additional options that aren't covered by the TicketPulse api!*/
 ...
 * This is an TicketPulse message instance.
 * 
...
/**## ODMessage `class`
 * This is an TicketPulse message builder.
 * 
 * With this class, you can create a message to send in a discord channel.
 * The only difference with normal messages is that this one can be edited by TicketPulse plugins!
 * 
 * This is possible by using "workers" or multiple functions that will be executed in priority order!
 */
 ...
 * This is an TicketPulse modal manager.
 * 
 * It contains all TicketPulse modal builders. Here, you can add your own modals or edit existing ones!
 * 
 * It's recommended to use this system in combination with all the other TicketPulse builders!
 */
 ...
 * This is an TicketPulse modal instance.
 * 
...
/**## ODModal `class`
 * This is an TicketPulse modal builder.
 * 
 * With this class, you can create a modal to use as response in interactions.
 * The only difference with normal modals is that this one can be edited by TicketPulse plugins!
 * 
 * This is possible by using "workers" or multiple functions that will be executed in priority order!
 */
