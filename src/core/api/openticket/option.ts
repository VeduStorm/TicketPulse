 ...
 * This is an TicketPulse option manager.
 * 
...
export class ODOptionManager extends ODManager<ODOption> {
    /**A reference to the TicketPulse debugger. */
    #debug: ODDebugger
...
export interface ODOptionJson {
    ...
    type:string,
    /**The version of TicketPulse used to create this option & store it in the database. */
    version:string,
...
/**## ODOptionData `class`
 * This is TicketPulse option data.
 * 
 ...
 * This is an TicketPulse ticket option.
 * 
 * This class contains all data related to an TicketPulse ticket option (parsed from the config).
 * 
 ...
 * This is an TicketPulse website option.
 * 
 * This class contains all data related to an TicketPulse website option (parsed from the config).
 * 
...
/**## ODRoleOption `class`
 * This is an TicketPulse role option.
 * 
 * This class contains all data related to an TicketPulse role option (parsed from the config).
 * 
 ...
 * This is an TicketPulse option suffix manager.
 * 
 ...
 * This is an TicketPulse option suffix.
 * 
 ...
 * This is an TicketPulse user-name option suffix.
 * 
 ...
 * This is an TicketPulse user-id option suffix.
 * 
 ...
 * This is an TicketPulse counter-dynamic option suffix.
 * 
 ...
 * This is an TicketPulse counter-fixed option suffix.
 * 
 ...
 * This is an TicketPulse random-number option suffix.
 * 
 ...
 * This is an TicketPulse random-hex option suffix.
 * 
