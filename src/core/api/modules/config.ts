 ...
 * This is an TicketPulse config manager.
 * 
 * It manages all config files in the bot and allows plugins to access config files from TicketPulse & other plugins!
 * 
...
/**## ODConfig `class`
 * This is an TicketPulse config helper.
...
/**## ODJsonConfig `class`
 * This is an TicketPulse JSON config.
