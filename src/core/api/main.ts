...
/**## ODMain `class`
 * This is the main TicketPulse class.
...
export class ODMain {
    ...
    debug: ODDebugger
    /**The manager containing all TicketPulse events. */
    ...
    /**The manager that manages & renders the TicketPulse help menu. (not the embed, but the text) */
    helpmenu: ODHelpMenuManager_Default
    /**The manager that manages, saves & renders the TicketPulse statistics. (not the embed, but the text & database) */
    ...
    /**This manager contains A LOD of booleans. With these switches, you can turn off "default behaviours" from the bot. This is used if you want to replace the default TicketPulse code.  */
    ...
    /**Log a message to the console. But in the TicketPulse style :) */
