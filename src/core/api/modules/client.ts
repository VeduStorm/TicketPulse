 ...
 * This is an TicketPulse client manager.
 * 
...
export class ODClientManager {
    ...
    /**(❌ DO NOT OVERWRITE ❌) Internal TicketPulse function to continue the startup when the client is ready! */
 ...
 * This is an TicketPulse client activity manager.
 * 
...
export interface ODSlashCommandBuilder extends discord.ChatInputApplicationCommandData {
    ...
    dmPermission?:boolean
    /**This field is required in TicketPulse for future compatibility. */
...
export class ODSlashCommandComparator {
    /**Convert a `discord.ApplicationCommandOptionChoiceData<string>` to a universal TicketPulse slash command option choice object for comparison. */
    ...
    /**Convert a `discord.ApplicationCommandOptionData` to a universal TicketPulse slash command option object for comparison. */
    ...
    /**Convert a `discord.ApplicationCommandOption` to a universal TicketPulse slash command option object for comparison. */
    ...
    /**Convert a `ODSlashCommandBuilder` to a universal TicketPulse slash command object for comparison. */
    ...
    /**Convert a `discord.ApplicationCommand` to a universal TicketPulse slash command object for comparison. */
 ...
 * This is an TicketPulse client slash manager.
 * 
...
export class ODSlashCommandManager extends ODManager<ODSlashCommand> {
    ...
    /**Remove all commands that are registered but unused by TicketPulse. */
 ...
 * This is an TicketPulse slash command.
 * 
...
/**## ODTextCommand `class`
 * This is an TicketPulse text command.
 * 
 ...
 * This is an TicketPulse client text manager.
 * 
