 ...
 * This is an TicketPulse session manager.
 * 
 * It contains all sessions in TicketPulse. Sessions are a sort of temporary storage which will be cleared when the bot stops.
...
/**## ODSession `class`
 * This is an TicketPulse session.
 * 
