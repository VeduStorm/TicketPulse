 ...
 * This is an TicketPulse stats manager.
 * 
...
export class ODStatsManager extends ODManager<ODStatScope> {
    ...
    #debug: ODDebugger
    /**Alias to TicketPulse stats database. */
...
/**## ODStatScope `class`
 * This is an TicketPulse stat scope.
 * 
 ...
 * 
 * The built-in TicketPulse scopes are: `global`, `user`, `ticket`
 */
 ...
 * This is an TicketPulse stat global scope.
 * 
 * A scope can contain multiple stats. Every scope is seperated from other scopes.
 * Here, you can read & write the values of all stats.
 * 
 * This scope is made specifically for the global stats of TicketPulse.
 */
...
/**## ODStat `class`
 * This is an TicketPulse statistic.
 * 
...
/**## ODBasicStat `class`
 * This is an TicketPulse basic statistic.
 * 
...
/**## ODDynamicStat `class`
 * This is an TicketPulse dynamic statistic.
 * 
 ...
 * 
 * This is used in TicketPulse for the live ticket status, participants & system status.
 */
