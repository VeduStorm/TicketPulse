 ...
 * 
 * Questions? Visit our discord server: https://discord.gg/6Rfg34EDkU
 */
    ...
    opendiscord.transcripts.add(new api.ODTranscriptCompiler<{url:string,availableUntil:Date},{auth:string}|null>("opendiscord:html-compiler",async (ticket,channel,user) => {
        ...
        if (res.status == 200 && res.body){
            ...
            if (res.status == 503){
                ...
                return {success:false,errorReason:"The HTML Transcripts are unreachable because the bot has been banned from using the API. If you don't know why, please contact us at https://discord.gg/6Rfg34EDkU",pendingMessage:null,initData:null}
                ...
                return {success:false,errorReason:"Something went wrong while compiling the HTML Transcripts, please report this error at https://discord.gg/6Rfg34EDkU",pendingMessage:null,initData:null}
        ...
        const htmlFinal: api.ODTranscriptHtmlV2Data = {
            ...
            premium:{
                ...
                customCredits:{
                    enable:false,
                    replaceText:"Powered By TicketPulse",
                    replaceURL:"https://github.com/VeduStorm",
                    enableReportBug:true
                },
                customHeaderUrl:{
                    enabled:false,
                    url:"https://github.com/VeduStorm",
                    text:"Hello!"
                },
                customTranscriptUrl:{
                    enabled:false,
        ...
        if (res.status == 200 && res.body){
            ...
            if (res.status == 503){
                ...
                return {ticket,channel,user,success:false,errorReason:"The HTML Transcripts are unreachable because the bot has been banned from using the API. If you don't know why, please contact us at https://discord.gg/6Rfg34EDkU",messages:null,data:null}
                ...
                return {ticket,channel,user,success:false,errorReason:"Something went wrong while compiling the HTML Transcripts, please report this error at https://discord.gg/6Rfg34EDkU",messages:null,data:null}
