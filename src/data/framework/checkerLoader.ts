...
export const registerDefaultCheckerSystemTranslations = (tm:api.ODCheckerTranslationRegister_Default,lm:api.ODLanguageManager_Default) => {
    //SYSTEM
    //tm.quickTranslate(lm,"checker.system.headerOpenTicket","other","opendiscord:header-openticket") //TicketPulse (ignore)
...
export const defaultGeneralStructure = new api.ODCheckerObjectStructure("opendiscord:general",{children:[
    ...
    {key:"_INFO",optional:false,priority:0,checker:new api.ODCheckerObjectStructure("opendiscord:info",{children:[
        {key:"support",optional:false,priority:0,checker:new api.ODCheckerStringStructure("opendiscord:info-support",{choices:["https://github.com/VeduStorm"]})},
        {key:"discord",optional:false,priority:0,checker:new api.ODCheckerStringStructure("opendiscord:info-discord",{choices:["https://discord.gg/6Rfg34EDkU"]})},
    ]})},
