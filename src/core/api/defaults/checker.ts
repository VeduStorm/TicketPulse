...
export class ODCheckerRenderer_Default extends ODCheckerRenderer {
    ...
    getComponents(compact:boolean, renderEmpty:boolean, translation:ODCheckerTranslationRegister_Default, data:ODCheckerResult): string[] {
        ...
        const t = {
            headerOpenticket:tm.get("other","opendiscord:header-openticket") ?? "TicketPulse",
        ...
        const footerSupportText = tm.insertTranslationParams(t.footerSupport,[ansis.green("https://discord.gg/6Rfg34EDkU"),ansis.green("https://github.com/VeduStorm")])
