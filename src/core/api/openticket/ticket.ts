 ...
 * This is an TicketPulse ticket manager.
 * 
...
export class ODTicketManager extends ODManager<ODTicket> {
    ...
    /**A reference to the TicketPulse client manager. */
...
export interface ODTicketJson {
    ...
    option:string,
    /**The version of TicketPulse used to create this ticket. */
    version:string,
...
/**## ODTicketData `class`
 * This is TicketPulse ticket data.
 * 
