...
/**## ODPostManager `class`
 * This is an TicketPulse post manager.
 * 
...
/**## ODPost `class`
 * This is an TicketPulse post class.
 * 
 ...
 * 
 * This class also contains utilities for sending messages via the TicketPulse builders.
 */
export class ODPost<ChannelType extends discord.GuildBasedChannel> extends ODManagerData {
    ...
    /**Send a message to this channel using the TicketPulse builder system */
