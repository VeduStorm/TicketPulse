...
const tempError = () => {
    if (tempErrors.length > 0){
        console.log("\n\n==============================\n[TicketPulse ERROR]: "+tempErrors.join("\n[TicketPulse ERROR]: ")+"\n==============================\n\n")
        process.exit(1)
    }
    tempErrors = []
}
...
if (Number(nodev[0]) < 18){
    tempErrors.push("Invalid node.js version. TicketPulse requires node.js v18 or above!")
}
tempError()
...
export interface ODUtilities {
     ...
     * Check if you're running a beta version of TicketPulse.
     */
    isBeta:boolean
     ...
     * Object containing data for TicketPulse easter eggs.
     */
    easterEggs: api.ODEasterEggs,
    /**## ODVersionMigration `utility class`
     * This class is used to manage data migration between TicketPulse versions.
     * 
...
export const utilities: ODUtilities = {
    ...
    easterEggs:{
        ...
        creator:"1104705926558130207", //DJj123dj
        translators:[
