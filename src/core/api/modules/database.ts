 ...
 * This is an TicketPulse database manager.
 * 
...
/**## ODDatabase `class`
 * This is an TicketPulse database template.
 ...
 * This is an TicketPulse JSON database.
 ...
 * This is an TicketPulse Formatted JSON database.
 * It stores data in a `json` file as a large `Array` using the `category`, `key`, `value` strategy.
 * You can store the following types: `string`, `number`, `boolean`, `array`, `object` & `null`!
 * 
