 ...
 * This is a collection of all the supported console colors within TicketPulse.
 */
export type ODValidConsoleColor = "white"|"red"|"yellow"|"green"|"blue"|"gray"|"cyan"|"magenta"

/**## ODConsoleMessageParam `type`
 * This interface contains all data required for a console log parameter within TicketPulse.
 */
 ...
 * This is an TicketPulse console message.
 * 
 ...
 * This is an TicketPulse console info message.
 * 
 ...
 * This is an TicketPulse console system message.
 * 
 ...
 * This is an TicketPulse console plugin message.
 * 
 ...
 * This is an TicketPulse console debug message.
 * 
 ...
 * This is an TicketPulse console warning message.
 * 
 ...
 * This is an TicketPulse console error message.
 * 
 ...
 * This is a collection of all the default console message types within TicketPulse.
 */
export type ODConsoleMessageTypes = "info"|"system"|"plugin"|"debug"|"warning"|"error"

/**## ODConsoleManager `class`
 * This is the TicketPulse console manager.
 * 
 * It handles the entire console system of TicketPulse. It's also the place where you need to log `ODConsoleMessage`'s.
...
export class ODConsoleManager {
    ...
    /**Log a message to the console ... But in the TicketPulse way :) */
 ...
 * This is the TicketPulse debug file manager.
 * 
 * It manages the TicketPulse debug file (`otdebug.txt`) which keeps a history of all system logs.
...
/**## ODDebugger `class`
 * This is the TicketPulse debugger.
 * 
...
export class ODDebugger {
    /**An alias to the TicketPulse console manager. */
 ...
 * This is the TicketPulse livestatus source.
 * 
 ...
 * This is the TicketPulse livestatus file source.
 * 
 ...
 * This is the TicketPulse livestatus url source.
 * 
 ...
 * This is the TicketPulse livestatus manager.
 * 
 ...
 * This is the TicketPulse livestatus renderer.
 * 
