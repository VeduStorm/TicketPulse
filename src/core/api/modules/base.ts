...
/**## ODValidId `type`
 * This is a valid TicketPulse identifier. It can be an `ODId` or `string`!
 * 
 * You will see this type in many functions from TicketPulse.
 */
...
/**## ODId `class`
 * This is an TicketPulse identifier.
 * 
 ...
 * This is an TicketPulse manager change helper.
 * 
 ...
 * @deprecated ### Will be removed in TicketPulse `v4.1.0`!
 * 
 * This is TicketPulse ticket manager redirect helper.
 * 
...
/**## ODManagerData `class`
 * This is TicketPulse manager data.
 * 
...
/**## ODManager `class`
 * This is an TicketPulse manager.
 * 
...
export class ODManager<DataType extends ODManagerData> extends ODManagerChangeHelper {
    ...
    /**Use the TicketPulse debugger in this manager for logs*/
 ...
 * This is an TicketPulse safe manager.
 * 
...
/**## ODVersion `class`
 * This is an TicketPulse version.
 * 
 * It has many features like comparing versions & checking if they are compatible.
 * 
 * You can use it in your own plugin, but most of the time you will use it to check the TicketPulse version!
 */
        ...
        return new Promise(async (resolve,reject) => {
            try{
                ...
                if (this.throwOnError) return reject("[OPENTICKET ERROR]: ODHTTPGetRequest => Unknown fetch() error: "+err)
                    ...
                    status:500,
                    body:"TicketPulse Error: Unknown fetch() error: "+err,
                })
            }
        })
    }
        ...
        return new Promise(async (resolve,reject) => {
            try{
                ...
                if (this.throwOnError) return reject("[OPENTICKET ERROR]: ODHTTPPostRequest => Unknown fetch() error: "+err)
                    ...
                    status:500,
                    body:"TicketPulse Error: Unknown fetch() error!",
                })
            }
        })
    }
 ...
 * 
 * This wrapper is made for TicketPulse system errors! **It can only be used by TicketPulse itself!**
 */
 ...
 * A wrapper for the node.js `Error` class that makes the error look better in the console!
 * 
 * This wrapper is made for TicketPulse plugin errors! **It can only be used by plugins!**
 */
