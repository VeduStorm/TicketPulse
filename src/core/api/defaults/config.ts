...
export interface ODJsonConfig_DefaultInfo {
    /**A link to the TicketPulse documentation. */
    support:string,
    /**A link to the DJdj Development discord server. */
    discord:string,
    /**The version of TicketPulse this config is compatible with. */
    version:string
}
 ...
 * Configure permissions for all TicketPulse commands & actions.
 */
 ...
 * Configure dm & log messages for all TicketPulse commands & actions.
 */
